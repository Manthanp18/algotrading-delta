...
/**
 * @deprecated This class is deprecated. Use LiveDataFetcherWS instead for better performance and lower API costs.
 * LiveDataFetcherWS provides WebSocket-first data fetching with REST API fallback, 
 * reducing API calls by 95% compared to this REST-only implementation.
 */
class LiveDataFetcher extends EventEmitter {
  constructor(apiKey, apiSecret, baseUrl = 'https://api.india.delta.exchange') {
    super();
    console.warn('⚠️  DEPRECATED: LiveDataFetcher is deprecated. Use LiveDataFetcherWS for better performance and lower costs.');
    this.apiKey = apiKey;
